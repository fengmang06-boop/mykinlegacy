  ...
  const bodyText = renderTemplate(
    input.body_template ??
      [
        ...
        "{{download_vault_link}}",
        "",
        "Inside you will find the primary Family Legacy Certificate, the Final Crest, the Family Story, Meaning Behind Your Crest, and the Complete Collection archive.",
        "",
...
function renderBrandedDeliveryHtml(variables: Record<string, string>): string {
  ...
  return [
    ...
    '<p style="margin:0;color:#5d4a2b;font-size:14px;line-height:1.6;"><strong>What is inside:</strong> the primary Family Legacy Certificate, the Final Crest, the Family Story, Meaning Behind Your Crest, and the Complete Collection archive.</p>',
    '</div>',
